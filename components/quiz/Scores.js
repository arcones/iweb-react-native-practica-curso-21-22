...
import { styles,SECONDARY_PINK } from '../css/Styles'
...
const Scores = ({ score, setFinished, setScore, setCurrentQuiz }) => {
    ...
    return (
        <Stack style={styles.quizPadding} fill center spacing={4}>
            ...
            <Button title="Reiniciar"  color={SECONDARY_PINK} tintColor="white"  onPress={reset} trailing={props => <Ionicons name="color-wand-outline" {...props} />} />
        </Stack>
    )
}
